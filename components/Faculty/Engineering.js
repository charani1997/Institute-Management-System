        ...
        <div>
            ...
            <div>
                ...
                <h1 className='bg-light text-dark fw-bold'><strong>DEPARTMENT OF CIVIL ENGINEERING</strong></h1>
                    <p className='bg-dark text-white'><h6 className='ms-4 me-4 pt-3 py-3'>IN THE PRESENT ERA WHEN GOOD LIVING AND EXCELLENT SERVICES TAKES PRECEDENCE OVER EVERY OTHER ASPECT OF LIFE, CIVIL ENGINEERING LEAPS AHEAD GIVING US AMENITIES TO A FIRM GRIP IN LIVING STYLE AND COMFORT .
                    ...
                    <h1 className='bg-light text-dark fw-bold'><strong>DEPARTMENT OF MECHANICAL ENGINEERING</strong></h1>
                    <p className='bg-dark text-white'><h6 className='ms-4 me-4 pt-3 py-3'>IN THE PRESENT DAY CONTEXT, ALL ASPECTS OF MECHANICAL ENGINEERING HAS VIVIDLY IMPROVED ITS VERY BROAD OUTLOOK, 
                    WITH THINGS NEW AND IMPROVED TECHNICAL MATERIAL, THAT WE COME ACROSS IN DAILY LIFE. THESE ENORMOUS DEVELOPMENTS DEMAND AN INFRASTRUCTURE FOR EFFICIENT ECONOMICAL MAINTENANCE OF THESE ASSETS, AND HENCE OUR DEPARTMENT TAKES A PLUNGE INTO THIS SIDE OF
                        ...
                        <h1 className='bg-light text-dark fw-bold'><strong>DEPARTMENT OF COMPUTER ENGINEERING</strong></h1>
                        <p className='bg-dark text-white'><h6 className='ms-4 me-4 pt-3 py-3'>THIS DEGREE PROGRAM PROVIDES STUDENTS WITH AN APPROPRIATE UNDERSTANDING OF SOFTWARE TECHNOLOGIES AND APPLICATIONS, SOFTWARE ENGINEERING, NETWORK TECHNOLOGIES, WEB TECHNOLOGIES, LEADERSHIP AND INDUSTRIAL KNOWLEDGE.<br/>
