...
function CourseDetail2(){
    ...
    return(
        <div className="container mt-3">
            <div className="row">
                <div className="col-8">
                    <h3>Course Title: MT202</h3>
                    <p className="fw-bold">Course Description: Real Analysis I</p>
                    <p className="fw-bold">Course By: <Link to="/staff-detail2/1">Dr. Kalpani Manathunga</Link></p>
                    <p className="fw-bold">Credits: 2</p>
                    ...
                    <ul className="list-group list-group-flush">
                        <li className="list-group-item">Introduction 1 
                            ...
                            <div class="modal-dialog modal-lg">
                                ...
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">CS402-Introduction 1</h5>
                        ...
                        <li className="list-group-item">Introduction 2 
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">CS402-Introduction 2</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div className="modal-body">
                                    <div class="ratio ratio-16x9">
                        ...
                        <li className="list-group-item">Introduction 3 
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">CS402-Introduction 3</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div className="modal-body">
                                    <div class="ratio ratio-16x9">
                        ...
                        <li className="list-group-item">Introduction 4 
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">CS402-Introduction 4</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div className="modal-body">
                                    <div class="ratio ratio-16x9">
